...
Lane <-  data2[18,4]
Place <-  data2[19,4]
OfficialTime <-  (as.numeric(data2[23,4]))/conversionfactor
WinningTime <-  (as.numeric(data2[24,4]))/conversionfactor
...
write.table(racedata, file, sep=",", row.names = FALSE, col.names=FALSE)
...
metadata <- rbind(a)
write.table(metadata, Athleterace, sep=",", row.names = FALSE, col.names=FALSE)
...
Lane <-  data3[18,4]
Place <-  data3[19,4]
OfficialTime <-  (as.numeric(data3[23,4]))/conversionfactor
WinningTime <-  (as.numeric(data3[24,4]))/conversionfactor
...
Lane <-  data4[18,4]
Place <-  data4[19,4]
OfficialTime <-  (as.numeric(data4[23,4]))/conversionfactor
WinningTime <-  (as.numeric(data4[24,4]))/conversionfactor
